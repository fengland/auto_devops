...
try:
    def get_24h_info(url):
        ...
        mail.MAIL_CONTENT = mail.MAIL_CONTENT + "IDC:"+ f"{idc}\t" + "节点号：" + f"{node_no}" + "\t" + "有效算力：" + f"{human_quality_adjust_power}"
        ...
        mail.MAIL_CONTENT = mail.MAIL_CONTENT + "\t\t" + "24H算力增量：" + str(power_incr) + "\t\t" + "24H出块数：" + str(
            blocks) + "\t\t" + "出块奖励：" + str(
            blocks_rewards) + "\t" + "错误区块："+ f"{fault_sector_count}"+"\n\t\t" +"24h幸运值：" + f"{lucky}"
        # print(mail.MAIL_CONTENT)
